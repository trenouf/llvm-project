...
; GFX8-NEXT:    s_waitcnt lgkmcnt(0)
; GFX8-NEXT:    s_sext_i32_i8 s5, s2
; GFX8-NEXT:    s_sext_i32_i8 s6, s3
; GFX8-NEXT:    s_bfe_i32 s8, s3, 0x80008
; GFX8-NEXT:    v_mov_b32_e32 v0, s6
; GFX8-NEXT:    v_mov_b32_e32 v1, s4
; GFX8-NEXT:    s_bfe_i32 s10, s3, 0x80010
; GFX8-NEXT:    v_mad_i32_i24 v0, s5, v0, v1
; GFX8-NEXT:    s_bfe_i32 s7, s2, 0x80008
; GFX8-NEXT:    v_mov_b32_e32 v1, s8
; GFX8-NEXT:    s_bfe_i32 s9, s2, 0x80010
...
; GFX9-NODL-NEXT:    s_waitcnt lgkmcnt(0)
; GFX9-NODL-NEXT:    s_sext_i32_i8 s5, s2
; GFX9-NODL-NEXT:    s_sext_i32_i8 s6, s3
; GFX9-NODL-NEXT:    s_bfe_i32 s8, s3, 0x80008
; GFX9-NODL-NEXT:    v_mov_b32_e32 v0, s6
; GFX9-NODL-NEXT:    v_mov_b32_e32 v1, s4
; GFX9-NODL-NEXT:    s_bfe_i32 s10, s3, 0x80010
; GFX9-NODL-NEXT:    v_mad_i32_i24 v0, s5, v0, v1
; GFX9-NODL-NEXT:    s_bfe_i32 s7, s2, 0x80008
; GFX9-NODL-NEXT:    v_mov_b32_e32 v1, s8
; GFX9-NODL-NEXT:    s_bfe_i32 s9, s2, 0x80010
; GFX9-NODL-NEXT:    v_mad_i32_i24 v0, s7, v1, v0
; GFX9-NODL-NEXT:    v_mov_b32_e32 v1, s10
; GFX9-NODL-NEXT:    s_ashr_i32 s3, s3, 24
; GFX9-NODL-NEXT:    v_mad_i32_i24 v0, s9, v1, v0
...
; GFX9-DL-NEXT:    v_dot4_i32_i8 v2, s2, v0, v1
...
; GFX8-NEXT:    s_bfe_i32 s10, s3, 0x80010
; GFX8-NEXT:    v_mad_i32_i24 v1, s7, v2, v1
; GFX8-NEXT:    s_bfe_i32 s9, s2, 0x80010
; GFX8-NEXT:    v_mad_i32_i24 v0, s5, v0, v1
; GFX8-NEXT:    v_mov_b32_e32 v1, s10
; GFX8-NEXT:    s_ashr_i32 s3, s3, 24
...
; GFX9-NODL-NEXT:    v_mov_b32_e32 v1, s4
; GFX9-NODL-NEXT:    s_bfe_i32 s7, s2, 0x80008
; GFX9-NODL-NEXT:    v_mad_i32_i24 v1, s5, v0, v1
; GFX9-NODL-NEXT:    v_mov_b32_e32 v2, s8
; GFX9-NODL-NEXT:    s_bfe_i32 s10, s3, 0x80010
; GFX9-NODL-NEXT:    v_mad_i32_i24 v1, s7, v2, v1
; GFX9-NODL-NEXT:    s_bfe_i32 s9, s2, 0x80010
; GFX9-NODL-NEXT:    v_mad_i32_i24 v0, s5, v0, v1
; GFX9-NODL-NEXT:    v_mov_b32_e32 v1, s10
; GFX9-NODL-NEXT:    s_ashr_i32 s3, s3, 24
...
; GFX9-DL-NEXT:    s_load_dword s4, s[0:1], 0x0
; GFX9-DL-NEXT:    s_waitcnt lgkmcnt(0)
; GFX9-DL-NEXT:    s_sext_i32_i8 s5, s2
; GFX9-DL-NEXT:    s_sext_i32_i8 s6, s3
; GFX9-DL-NEXT:    s_bfe_i32 s8, s3, 0x80008
; GFX9-DL-NEXT:    v_mov_b32_e32 v0, s6
; GFX9-DL-NEXT:    v_mov_b32_e32 v1, s4
; GFX9-DL-NEXT:    s_bfe_i32 s7, s2, 0x80008
; GFX9-DL-NEXT:    v_mad_i32_i24 v1, s5, v0, v1
; GFX9-DL-NEXT:    v_mov_b32_e32 v2, s8
; GFX9-DL-NEXT:    s_bfe_i32 s10, s3, 0x80010
; GFX9-DL-NEXT:    v_mad_i32_i24 v1, s7, v2, v1
; GFX9-DL-NEXT:    s_bfe_i32 s9, s2, 0x80010
; GFX9-DL-NEXT:    v_mad_i32_i24 v0, s5, v0, v1
; GFX9-DL-NEXT:    v_mov_b32_e32 v1, s10
; GFX9-DL-NEXT:    s_ashr_i32 s3, s3, 24
; GFX9-DL-NEXT:    v_mad_i32_i24 v0, s9, v1, v0
...
; GFX8-NEXT:    s_ashr_i32 s7, s3, 24
; GFX8-NEXT:    s_bfe_i32 s8, s3, 0x80010
; GFX8-NEXT:    s_sext_i32_i8 s3, s3
; GFX8-NEXT:    s_ashr_i32 s5, s2, 24
; GFX8-NEXT:    s_bfe_i32 s6, s2, 0x80010
...
; GFX8-NEXT:    v_mad_i32_i24 v2, s5, v1, v0
; GFX8-NEXT:    v_mov_b32_e32 v0, s0
; GFX8-NEXT:    v_mov_b32_e32 v1, s1
; GFX8-NEXT:    flat_store_dword v[0:1], v2
; GFX8-NEXT:    s_endpgm
...
; GFX9-NODL-NEXT:    s_ashr_i32 s7, s3, 24
; GFX9-NODL-NEXT:    s_bfe_i32 s8, s3, 0x80010
; GFX9-NODL-NEXT:    s_sext_i32_i8 s3, s3
; GFX9-NODL-NEXT:    s_ashr_i32 s5, s2, 24
; GFX9-NODL-NEXT:    s_bfe_i32 s6, s2, 0x80010
...
; GFX9-DL-NEXT:    s_ashr_i32 s7, s3, 24
; GFX9-DL-NEXT:    s_bfe_i32 s8, s3, 0x80010
; GFX9-DL-NEXT:    s_sext_i32_i8 s3, s3
; GFX9-DL-NEXT:    s_ashr_i32 s5, s2, 24
; GFX9-DL-NEXT:    s_bfe_i32 s6, s2, 0x80010
...
; GFX10-DL-NEXT:    s_load_dword s4, s[0:1], 0x0
; GFX10-DL-NEXT:    s_waitcnt lgkmcnt(0)
; GFX10-DL-NEXT:    v_and_b32_sdwa v1, s2, v0 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:BYTE_1 src1_sel:DWORD
...
; GFX10-DL-NEXT:    s_ashr_i32 s3, s3, 24
; GFX10-DL-NEXT:    v_mad_i32_i24 v0, v1, v0, v2
...
; GFX10-DL-NEXT:    v_and_b32_sdwa v4, sext(s0), v3 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:BYTE_1 src1_sel:DWORD
; GFX10-DL-NEXT:    s_lshr_b32 s5, s1, 16
; GFX10-DL-NEXT:    v_and_b32_sdwa v5, sext(s1), v3 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:BYTE_1 src1_sel:DWORD
...
; GFX10-DL-NEXT:    v_and_b32_sdwa v6, sext(s2), v3 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:BYTE_1 src1_sel:DWORD
; GFX10-DL-NEXT:    v_and_b32_sdwa v7, sext(s5), v3 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:BYTE_1 src1_sel:DWORD
